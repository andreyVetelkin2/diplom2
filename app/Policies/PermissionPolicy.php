...
class PermissionPolicy
{
    ...
    {
        $permission = Permission::where('slug', 'view-permissions')->first();
    ...
    {
        $permission = Permission::where('slug', 'edit-permissions')->first();
        return $user->hasPermissionTo($permission)
            ? Response::allow()
            : Response::denyAsNotFound();
    }
    ...
    {
        $permission = Permission::where('slug', 'delete-permissions')->first();
        return $user->hasPermissionTo($permission)
            ? Response::allow()
            : Response::denyAsNotFound();
    }
